  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
          ...
          <div className={fadeIn('xl')}>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="text-white hover:text-[#ae1b22] transition-colors"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
        ...
        <div
          className={`mt-8 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center ${fadeIn('lg')}`}
        >
          <p className="text-white text-sm">
            &copy; {new Date().getFullYear()} Ohio Golf Club. All rights
            reserved.
          </p>
