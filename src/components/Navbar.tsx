    ...
    <header className="fixed top-4 left-4 right-4 z-50 flex justify-center items-center">
      ...
      >
        <div className="flex items-center justify-between gap-8">
          ...
          {/* Desktop Navigation */}
          <nav
            className={`hidden lg:flex items-center lg:space-x-4 xl:space-x-8 shrink-0 ${fadeIn("sm")}`}
          >
            <Link
              href="#lessons"
              className="text-[#011E41] text-sm xl:text-base font-bold hover:text-primary transition-colors shrink-0"
            >
              Lessons & Fittings
            </Link>
            <Link
            ...
            <Link
              href="https://customer-cc29.clubcaddie.com/customer-login?clubid=103408"
              target="_blank"
              className="text-[#011E41] text-sm xl:text-base font-bold hover:text-primary transition-colors shrink-0"
            >
              Customer Login
        ...
        {/* Mobile Menu Overlay */}
        {isMenuOpen && (
          <div className="lg:hidden max-h-[80vh] pt-8 overflow-y-auto flex items-center justify-center">
