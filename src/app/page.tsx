        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          >
            <Button
              ...
              onClick={() => openModal('Book a Lesson')}
            >
              Book a Lesson
            </Button>
            <Button
              variant="secondary"
              onClick={() => openModal('Club Fittings')}
            >
              Club Fittings
            </Button>
          </div>
      ...
      <Section className="bg-[#121212] text-white" id="memberships-benefits">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <Button
              variant="black"
              onClick={() => openModal('Premium Membership')}
            >
              Join Now
            </Button>
          </div>
          ...
          >
            ...
            <Button
              variant="red"
              style={{ borderColor: '#ae1b22' }}
              onClick={() => openModal('Elite Membership')}
            >
              Join Now
            </Button>
          </div>
